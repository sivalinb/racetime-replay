...
Credentials are configured only in the ignored local `.env`. Live ingestion verification covers this synthetic trace; scored experiment import, dashboards and production monitoring are separate work.
